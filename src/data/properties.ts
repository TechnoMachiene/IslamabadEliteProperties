...
export const citySectors: Record<string, string[]> = {
  ...
  rawalpindi: ["Bahria Town", "DHA Rawalpindi"],
};
...
export const subSectors: Record<string, string[]> = {
  ...
  "Bahria Town":     ["BT Phase 1", "BT Phase 2", "BT Phase 7", "BT Orchard"],
  "DHA Rawalpindi":  ["DHA Phase 1", "DHA Phase 2", "DHA Phase 3"],
};
